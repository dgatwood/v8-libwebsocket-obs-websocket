...
var OBSWebSocket = (function () {
    ...
    function s(e) {
        ...
        return (
            (s = function (e) {
                ...
                return (o.prototype = Object.create(e.prototype, { constructor: { value: o, enumerable: !1, writable: !0, configurable: !0 } })), r(o, e);
            }),
            s(e)
        );
    }
        ...
        h = function (e, t) {
            ...
            if ("number" === n && isFinite(e))
                return t.long
                    ? (function (e) {
                          var t = Math.abs(e);
                          return t >= d ? p(e, t, d, "day") : t >= l ? p(e, t, l, "hour") : t >= f ? p(e, t, f, "minute") : t >= u ? p(e, t, u, "second") : e + " ms";
                      })(e)
                    : (function (e) {
                          var t = Math.abs(e);
                          return t >= d ? Math.round(e / d) + "d" : t >= l ? Math.round(e / l) + "h" : t >= f ? Math.round(e / f) + "m" : t >= u ? Math.round(e / u) + "s" : e + "ms";
                      })(e);
    ...
    var v = a(function (e, t) {
                ...
                (e.exports = (function (e) {
                    function t(e) {
                        ...
                        function c(...e) {
                            ...
                            const n = c,
                                o = Number(new Date());
                            (n.diff = o - (r || o)), (n.prev = r), (n.curr = o), (r = o), (e[0] = t.coerce(e[0])), "string" != typeof e[0] && e.unshift("%O");
                            let i = 0;
                            (e[0] = e[0].replace(/%([a-zA-Z%])/g, (r, o) => {
                                if ("%%" === r) return "%";
                                i++;
                                const s = t.formatters[o];
                                return "function" == typeof s && ((r = s.call(n, e[i])), e.splice(i, 1), i--), r;
                            })),
        ...
        y = a(function (e) {
            ...
            function i(e, t, r, i, s) {
                ...
                var c = new o(r, i || e, s),
                    a = n ? n + t : t;
                return e._events[a] ? (e._events[a].fn ? (e._events[a] = [e._events[a], c]) : e._events[a].push(c)) : ((e._events[a] = c), e._eventsCount++), e;
            }
            function s(e, t) {
            ...
            Object.create && ((r.prototype = Object.create(null)), new r().__proto__ || (n = !1)),
                ...
                (c.prototype.listeners = function (e) {
                    ...
                    if (!t) return [];
                    if (t.fn) return [t.fn];
                    for (var r = 0, o = t.length, i = new Array(o); r < o; r++) i[r] = t[r].fn;
                    return i;
                }),
                        ...
                        for (u = 0; u < h; u++)
                            switch ((f[u].once && this.removeListener(e, f[u].fn, void 0, !0), l)) {
                                ...
                                case 4:
                                    ...
                                    break;
                                default:
                                    if (!a) for (d = 1, a = new Array(l - 1); d < l; d++) a[d - 1] = arguments[d];
                ...
                (c.prototype.removeListener = function (e, t, r, o) {
                    ...
                    if (c.fn) c.fn !== t || (o && !c.once) || (r && c.context !== r) || s(this, i);
                    else {
                        for (var a = 0, u = [], f = c.length; a < f; a++) (c[a].fn !== t || (o && !c[a].once) || (r && c[a].context !== r)) && u.push(c[a]);
                ...
                (c.prototype.removeAllListeners = function (e) {
                    var t;
                    return e ? this._events[(t = n ? n + e : e)] && s(this, t) : ((this._events = new r()), (this._eventsCount = 0)), this;
                }),
    ...
    "undefined" != typeof WebSocket
        ...
        ? (m = MozWebSocket)
        : void 0 !== c
        ? (m = c.WebSocket || c.MozWebSocket)
        : "undefined" != typeof window
        ? (m = window.WebSocket || window.MozWebSocket)
        : "undefined" != typeof self && (m = self.WebSocket || self.MozWebSocket);
    var g,
        C,
        w,
        b = m;
    !(function (e) {
        ...
        (function (e) {
            (e[(e.None = 0)] = "None"),
                ...
                (e[(e.SceneItemTransformChanged = 524288)] = "SceneItemTransformChanged");
        })(C || (C = {})),
        (function (e) {
            (e[(e.None = -1)] = "None"), (e[(e.SerialRealtime = 0)] = "SerialRealtime"), (e[(e.SerialFrame = 1)] = "SerialFrame"), (e[(e.Parallel = 2)] = "Parallel");
        })(w || (w = {}));
    var _ = { __proto__: null, default: {} },
        F = a(function (e, t) {
            var n;
            e.exports =
                ((n =
                    ...
                    (function (e, t) {
                        ...
                        if (
                            ...
                            !n && void 0 !== c && c.crypto && (n = c.crypto),
                            !n)
                        )
                            try {
                                n = _;
                        ...
                        var r = function () {
                            ...
                            u = (s.WordArray = a.extend({
                                ...
                                concat: function (e) {
                                    var t = this.words,
                                        ...
                                        r = this.sigBytes,
                                        o = e.sigBytes;
                                    if ((this.clamp(), r % 4)) for (var i = 0; i < o; i++) t[(r + i) >>> 2] |= ((n[i >>> 2] >>> (24 - (i % 4) * 8)) & 255) << (24 - ((r + i) % 4) * 8);
                            ...
                            d = (f.Latin1 = {
                                stringify: function (e) {
                                    for (var t = e.words, n = e.sigBytes, r = [], o = 0; o < n; o++) r.push(String.fromCharCode((t[o >>> 2] >>> (24 - (o % 4) * 8)) & 255));
                                    return r.join("");
                                },
                                parse: function (e) {
                            ...
                            p = (s.BufferedBlockAlgorithm = a.extend({
                                ...
                                _process: function (t) {
                                    var n,
                                        ...
                                        s = this.blockSize,
                                        c = i / (4 * s),
                                        a = (c = t ? e.ceil(c) : e.max((0 | c) - this._minBufferSize, 0)) * s,
                                        f = e.min(4 * a, i);
                                    if (a) {
            ...
            e.exports =
                ...
                (function (e) {
                    ...
                    !(function () {
                        ...
                        for (var r = 2, o = 0; o < 64; ) t(r) && (o < 8 && (c[o] = n(e.pow(r, 0.5))), (a[o] = n(e.pow(r, 1 / 3))), o++), r++;
                    })();
                    var u = [],
                        f = (s.SHA256 = i.extend({
                            _doReset: function () {
                            ...
                            _doProcessBlock: function (e, t) {
                                for (var n = this._hash.words, r = n[0], o = n[1], i = n[2], s = n[3], c = n[4], f = n[5], l = n[6], d = n[7], h = 0; h < 64; h++) {
                                    if (h < 16) u[h] = 0 | e[t + h];
                                    else {
                                        var p = u[h - 15],
                                            v = u[h - 2];
                                        u[h] = (((p << 25) | (p >>> 7)) ^ ((p << 14) | (p >>> 18)) ^ (p >>> 3)) + u[h - 7] + (((v << 15) | (v >>> 17)) ^ ((v << 13) | (v >>> 19)) ^ (v >>> 10)) + u[h - 16];
                                    }
                                    var y = (r & o) ^ (r & i) ^ (o & i),
                                        m = d + (((c << 26) | (c >>> 6)) ^ ((c << 21) | (c >>> 11)) ^ ((c << 7) | (c >>> 25))) + ((c & f) ^ (~c & l)) + a[h] + u[h];
                                    (d = l), (l = f), (f = c), (c = (s + m) | 0), (s = i), (i = o), (o = r), (r = (m + ((((r << 30) | (r >>> 2)) ^ ((r << 19) | (r >>> 13)) ^ ((r << 10) | (r >>> 22))) + y)) | 0);
                                }
                                (n[0] = (n[0] + r) | 0), (n[1] = (n[1] + o) | 0), (n[2] = (n[2] + i) | 0), (n[3] = (n[3] + s) | 0), (n[4] = (n[4] + c) | 0), (n[5] = (n[5] + f) | 0), (n[6] = (n[6] + l) | 0), (n[7] = (n[7] + d) | 0);
                            },
                ...
                (n.enc.Base64 = {
                    stringify: function (e) {
                        ...
                        for (var o = [], i = 0; i < n; i += 3)
                            for (
                                var s = (((t[i >>> 2] >>> (24 - (i % 4) * 8)) & 255) << 16) | (((t[(i + 1) >>> 2] >>> (24 - ((i + 1) % 4) * 8)) & 255) << 8) | ((t[(i + 2) >>> 2] >>> (24 - ((i + 2) % 4) * 8)) & 255), c = 0;
                                c < 4 && i + 0.75 * c < n;
                                c++
                            )
    ...
    var O = v("obs-websocket-js"),
        ...
        E = /*#__PURE__*/ (function (n) {
            function r() {
                ...
                return ((e = n.call.apply(n, [this].concat(r)) || this)._identified = !1), (e.internalListeners = new y()), (e.socket = void 0), e;
            }
            t(r, n),
            ...
            return (
                (s.connect = function (e, t, n) {
                    ...
                    try {
                        var r = function () {
                                    ...
                                    function () {
                                        ...
                                        return Promise.resolve(
                                            Promise.race([
                                                (function () {
                                                    try {
                                                        return Promise.resolve(o.createConnection(e)).then(function (e) {
                            ...
                            o = this,
                            i = (function () {
                                if (o.socket) return Promise.resolve(o.disconnect()).then(function () {});
                            })();
                ...
                (s.disconnect = function () {
                    try {
                        var e = this;
                        if (!e.socket || e.socket.readyState === b.CLOSED) return Promise.resolve();
                ...
                (s.reidentify = function (e) {
                    try {
                        var t = this.internalEventPromise("op:" + g.Identified);
                        return Promise.resolve(this.message(g.Reidentify, e)).then(function () {
                            return t;
                        });
                    } catch (e) {
                        return Promise.reject(e);
                ...
                (s.call = function (e, t) {
                    try {
                        ...
                        return Promise.resolve(this.message(g.Request, { requestId: n, requestType: e, requestData: t })).then(function () {
                            return Promise.resolve(o).then(function (e) {
                                var t = e.requestStatus,
                                    n = e.responseData;
                                if (!t.result) throw new j(t.code, t.comment);
                                return n;
                            });
                        });
                    } catch (e) {
                ...
                (s.cleanup = function () {
                    this.socket &&
                        ((this.socket.onopen = null), (this.socket.onmessage = null), (this.socket.onerror = null), (this.socket.onclose = null), (this.socket = void 0), (this._identified = !1), this.internalListeners.removeAllListeners());
                }),
                    ...
                    try {
                        ...
                        return (
                            ...
                            Promise.resolve(n).then(function () {
                                ...
                                if (n !== t.protocol) throw new j(-1, "Server sent an invalid subprotocol");
                                return r;
                            })
                        );
                    } catch (e) {
                ...
                (s.identify = function (t, n, r) {
                    ...
                    try {
                        var u = this,
                            f = e({ rpcVersion: c }, r);
                        s && n && (f.authentication = ((o = s.challenge), (i = P.stringify(S(n + s.salt))), P.stringify(S(i + o))));
                        var l = u.internalEventPromise("op:" + g.Identified);
                        return Promise.resolve(u.message(g.Identify, f)).then(function () {
                            return Promise.resolve(l).then(function (t) {
                                return (u._identified = !0), u.emit("Identified", t), e({ rpcVersion: c }, a, t);
                            });
                        });
                    } catch (e) {
                        return Promise.reject(e);
                ...
                (s.message = function (e, t) {
                    try {
                        ...
                        if (!n.identified && 1 !== e) throw new Error("Socket not identified");
                        return Promise.resolve(n.encodeMessage({ op: e, d: t })).then(function (e) {
                            n.socket.send(e);
                        });
                    } catch (e) {
                        return Promise.reject(e);
                ...
                (s.onMessage = function (e) {
                    try {
                        ...
                        return Promise.resolve(
                            x(
                                function () {
                                    return Promise.resolve(t.decodeMessage(e.data)).then(function (e) {
                                        var n = e.op,
                                            r = e.d;
                                        if ((O("socket.message: %d %j", n, r), void 0 !== n && void 0 !== r))
                                            switch (n) {
                                                case g.Event:
                                                    return void t.emit(r.eventType, r.eventData);
                                                case g.RequestResponse:
                                                    return void t.internalListeners.emit("res:" + r.requestId, r);
                                                default:
                ...
                (s.onError = function (e) {
                    O("socket.error: %o", e);
                    var t = new j(-1, e.message);
                    this.emit("ConnectionError", t), this.internalListeners.emit("ConnectionError", t);
                }),
                (s.onClose = function (e) {
                    O("socket.close: %s (%d)", e.reason, e.code);
                    var t = new j(e.code, e.reason);
                    this.emit("ConnectionClosed", t), this.internalListeners.emit("ConnectionClosed", t), this.cleanup();
                }),
                (o = r),
                (i = [
                    {
    ...
    (E.requestCounter = 1), "undefined" != typeof exports && Object.defineProperty(exports, "__esModule", { value: !0 });
    var A = /*#__PURE__*/ (function (e) {
            function n() {
                for (var t, n = arguments.length, r = new Array(n), o = 0; o < n; o++) r[o] = arguments[o];
                return ((t = e.call.apply(e, [this].concat(r)) || this).protocol = "obswebsocket.json"), t;
            }
            t(n, e);
            var r = n.prototype;
            return (
